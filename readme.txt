...
Tags: calculator, builder, calculoid, embed
...
With the **id** parameter you specify which calculator you want to display. You can use this shortcode anywhere in WordPress.

Plugin's configuration allows you to insert your API key, which you receive when you register to Calculoid.com. So if you want to embrace function of your Calculoid membership, insert your API key.

The calculator does not use iframe, so it is part of your HTML content, which is great, because it inherites your CSS styles and the calculator fit in. The same font, same color and so on.
